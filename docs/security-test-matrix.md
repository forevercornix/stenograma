...
| Audio valomas **tik po įsipareigoto** terminalaus perėjimo (`_handleFailure`) | `workerIdempotency.integration` | ⚠️ vietoje NEPAGAUNAMA — sujungimas, ne taisyklė (kaip M15/M16) |

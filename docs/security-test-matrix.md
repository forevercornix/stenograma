...
| ⚠️ **DR moduliuose NĖRA nuosavo trynimo SQL** | `erasureExportContract` (tripwire) | Mutacija M14 (`DELETE FROM jobs` įterptas į `erasureReplay`) → krinta. Komentarai nukerpami prieš palyginimą (#265), su kontrolėmis abiem kryptimis. ⚠️ STATINĖ patikra (§9.2): ji saugo nuo ANTROS trynimo semantikos, o ne įrodo šalinimą |

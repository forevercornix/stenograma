...
| Nesėkmės tvarkytojo atmetimas **negriauna worker'io** | `workerIdempotency.integration` | ⚠️ `EventEmitter` Promise nelaukia; permestas `UNKNOWN_SOURCE_STATUS` taptų neapdorotu atmetimu, ir nuodingas job'as žudytų procesą kiekvieno retry metu. Audio šioje šakoje NELIEČIAMAS |

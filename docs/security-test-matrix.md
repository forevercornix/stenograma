...
| ⚠️ **Praleidimas yra gedimas abiem dokumentuotais vardais** | `minioGuard` | Planas dokumentavo `REQUIRE_S3=1`, implementacija tikrino `REQUIRE_MINIO` — dokumentuota komanda praleisdavo vienintelį S3 rinkinį ir baigdavosi sėkme. Sargas, kurio vardas priklauso nuo to, kurį dokumentą skaitei, nėra sargas |

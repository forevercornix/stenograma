...
| Visas audio failas skaitomas į RAM | Jei tikitės daug vienalaikių ilgų (>50MB) įrašų, apsvarstykite tiesioginį srautinį (streaming) perdavimą tiekėjui arba failo apdorojimą per atskirą worker'į su didesniu atminties limitu, ne pačiame API procese. |
